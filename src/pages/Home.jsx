  ...
  return (
    <div className="min-h-screen bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="md:w-1/2 animate-fade-in-up">
              <img
                src={assets.home_img}
                alt="معرض نهلاء للأعمال اليدوية"
            ...
            <div className="md:w-1/2 mb-10 md:mb-0 order-last md:order-first animate-fade-in-up delay-200 md:pr-8">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                معرض نهلة للأعمال اليدوية
              </h1>
              <p className="text-xl text-gray-300 mb-8">
                اكتشف قطعاً فريدة من الأعمال اليدوية المصنوعة بحب وشغف
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-gradient-to-br from-rose-900 to-gray-800">
        <h2 className="text-3xl font-playfair font-bold text-center mb-12 text-white animate-fade-in-up">أحدث المنتجات</h2>
