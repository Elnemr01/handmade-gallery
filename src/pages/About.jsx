      ...
      <div className="py-20 bg-gradient-to-br from-gray-800 to-rose-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-8 animate-fade-in-up">About Nahlla Gallery</h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8 animate-fade-in-up delay-100">
              Welcome to Nahlla Gallery, where we bring you unique handmade pieces crafted with love and passion. 
              Our collection features carefully selected items that combine traditional craftsmanship with modern design.
            </p>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12 animate-fade-in-up delay-200">
              You can place your orders and connect with us through our social media platforms:
            </p>
